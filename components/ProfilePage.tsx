  ...
  return (
    <>
      <div className="p-2 animate-fadeIn h-full flex flex-col">
        <div className="pixel-border flex flex-col flex-grow">
          {/* Profile Header */}
          ...
          {game && game.inventory.length > 0 ? (
            ...
            <div className="flex-grow flex items-center justify-center text-center py-10 px-4 bg-black/30 border-2 border-dashed border-border-dark">
              <div>
